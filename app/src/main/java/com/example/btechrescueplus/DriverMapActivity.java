...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback,RoutingListener {
    ...
    private Button mLogout,mSettings,mrideStatus,mHistory, mHospital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHospital.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*String url = "https://covidhospitals.online";

                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i); */
                Uri uri = Uri.parse("https://resuceplus.netlify.app/"); // missing 'http://' will cause crashed
