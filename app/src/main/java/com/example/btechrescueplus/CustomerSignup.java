    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    Intent intent = new Intent(CustomerSignup.this, CustomerLoginActivity.class);
        ...
        msignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (awesomeValidation.validate()) {
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(CustomerSignup.this, new OnCompleteListener<AuthResult>() {
                        @Override
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(CustomerSignup.this, "Registered Successfully ! Please, check your Email for verification.", Toast.LENGTH_SHORT).show();
                                        }
                                        else{
