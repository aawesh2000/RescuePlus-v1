                            ...
                            if (!task.isSuccessful()) {
                                ...
                                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(CustomerRegistration.this, "Registered Successfully ! Please, check your Email for verification.", Toast.LENGTH_SHORT).show();

                                        }
                                        else{
                                            Toast.makeText(CustomerRegistration.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
